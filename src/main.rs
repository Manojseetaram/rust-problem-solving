...
// fn second_largest(n : Vec<i32>)-> i32{
//   let largest = n[0];
//   let  mut second_large = n[1];
//   for i in n.iter(){
//     let mut num = largest <= 1 ;
//     if i > &largest {
...
fn main(){
  ...
  let reverse = "Hello WordE";
   ...
   let order = vec!["Hello".to_string() , "Manoj".to_string() , "Seetaram".to_string() , "How".to_string()];
    ...
    println!("The second largest number : {}", second_largest(number.clone()));
    println!("The largest number : {}" ,largest(number.clone()) );
    println!("The smalest number : {}" ,smalest_number(number.clone()) );
    println!("The second smalest number : {}",smalest_secondnumber(number.clone()));
    ...
    println!("The factorial number is : {:?}" ,factorial_numbers(&num8));
